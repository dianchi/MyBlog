...
# ---------------------------------------------------------------------------------------
base_info:
  title: 应许之地-BatryCC个人博客 # Site title
  author: BatryCC # Author name
  url: http://blog.batrycc.top # Site url
...
style:
  ...
  first_screen:
    ...
    description: 应许之地 # the title in the middle of the first screen. HTML supported (e.g. svg html code of your logo)
...
footer:
  ...
  start_time: 2023/1/1 00:00:00 # the starting time of your website, format: yyyy/mm/dd hh:mm:ss
